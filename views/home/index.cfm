...
<form id="contact-form" method="post" action="#prc.xehContactSetting#" role="form">
    ...
    <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-inline no-margin">
                        <h3><i class="fa fa-bell fa-lg"></i> Send Pulse Push Settings</h3>
                    </div>
                </div>
                <div class="col-md-6">
                    <!--- Actions Bar --->
                    <div class="pull-right">
                        <a type="button" class="btn btn-sm btn-info" href="#prc.xehNotifyForm#"><i class="fa fa-cogs"></i> Notification Form</a>
        ...
        <div class="panel-body">
            ...
            <div class="row">            
                <div class="col-md-12">
                    <input type="submit" class="btn btn-success btn-send" value="Submit" id="submitBtn">
                </div>
            </div>
        </div>
    </div>
